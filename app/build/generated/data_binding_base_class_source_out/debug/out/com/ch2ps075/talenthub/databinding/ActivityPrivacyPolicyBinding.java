...
public final class ActivityPrivacyPolicyBinding implements ViewBinding {
  ...
  @NonNull
  public final Toolbar toolbarPrivacyPolicy;

  private ActivityPrivacyPolicyBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView ivBack, @NonNull Toolbar toolbarPrivacyPolicy) {
    this.rootView = rootView;
    this.ivBack = ivBack;
    this.toolbarPrivacyPolicy = toolbarPrivacyPolicy;
  }
  ...
  public static ActivityPrivacyPolicyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.toolbar_privacy_policy;
      Toolbar toolbarPrivacyPolicy = ViewBindings.findChildViewById(rootView, id);
      if (toolbarPrivacyPolicy == null) {
        break missingId;
      }

      return new ActivityPrivacyPolicyBinding((ConstraintLayout) rootView, ivBack,
          toolbarPrivacyPolicy);
    }
