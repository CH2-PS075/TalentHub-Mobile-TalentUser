...
import com.ch2ps075.talenthub.ui.auth.registertalent.RegisterTalentViewModel
...
class ViewModelFactory private constructor(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            modelClass.isAssignableFrom(RegisterTalentViewModel::class.java) -> {
                RegisterTalentViewModel(authRepository) as T
            }
